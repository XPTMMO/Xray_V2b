...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/XPTMMO/Xray_V2b/refs/heads/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/XPTMMO/Xray_V2b/refs/heads/main/xrayx.sh
